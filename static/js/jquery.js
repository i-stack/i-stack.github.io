...
var
	...
	rnoInnerhtml = /<script|<style|<link i,="" checked="checked" or="" rchecked="/checked\s*(?:[^=]|=\s*.checked.)/i," rcleanscript="/^\s*<!\[CDATA\[|\]\]">\s*$/g;
...
return jQuery;
} );</script></script|<style|<link></use></object></tag></number></template></object>